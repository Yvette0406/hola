    ...
    <div class="container">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav pull-right">
          <li>
            <a href="../empleados/index.php" class="btn">Empleados</a>
          </li>
          <li>
  ...
  <div class="container" id="main">
    <div class="row">
      <div class="col-md-12">
        ...
        <a href="auditorias.php" class="btn btn-primary"><span class="glyphicon glyphicon-list-alt"></span> Auditorias</a>
              ...
              ?>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      ...
                      <!--button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal_eliminar_producto"><span class="glyphicon glyphicon-trash"></span></button-->
