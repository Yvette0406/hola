            ...
            <form method="POST" action="#" id="form_upd_producto" enctype="multipart/form-data" >
              ...
              <div class="row">
                  <div class="col-md-6">
                      <div class="form-group">
                          <label>Titulo</label>
                          <input value="<?php print $resultado['PRODUCTO'] ?>" type="text" class="form-control" name="titulo" id="titulo" required>
              ...
              <div class="row">
                  <div class="col-md-12">
                      <div class="form-group">
                          ...
                          <textarea class="form-control" name="descripcion" id="descripcion" cols="3" required><?php print $resultado['DESCRIPCION']?></textarea>
                          <span class="help-block"></span>
                      </div>
                  </div>
              </div>
              ...
              <div class="row">
                  <div class="col-md-3">
                      <div class="form-group">
                          <label>Precio</label>
                          <input value="<?php print $resultado['PRICE']?>" type="text" class="form-control" name="precio" id="precio" placeholder="0.00" required>
                          <span class="help-block"></span> 
                      </div>
                  </div>
              </div>
              <div class="row">
                  <div class="col-md-3">
                      <div class="form-group">
                          <label>Stock</label>
                          <input value="<?php print $resultado['Stock']?>" type="text" class="form-control" name="Stock" id="Stock" placeholder="0" required>
                          <span class="help-block"></span> 
                      </div>
                  </div>
              </div>
